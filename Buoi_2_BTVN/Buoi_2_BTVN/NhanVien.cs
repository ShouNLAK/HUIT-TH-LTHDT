...
namespace Buoi_2_BTVN
{
    public class NhanVien
    {
        ...
        public void xuat()
        {
            Console.WriteLine("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\t{8}", MaNV, TenNV, PhongBan, ChucVu, HeSoLuong, ThamNienCT, SoNgayLamViec, tinh_PhuCap(), tinh_Luong());
        }
        public void nhap()
        {
            ...
            Console.Write("Nhap chuc vu (1 - Nhan vien | 2 - Lanh dao): ");
            ChucVu = Console.ReadLine();
            Console.Write("Nhap he so luong: ");
            HeSoLuong = double.Parse(Console.ReadLine());
            Console.Write("Nhap tham nien cong tac: ");
            ThamNienCT = double.Parse(Console.ReadLine());
            Console.Write("Nhap so ngay lam viec trong thang: ");
            SoNgayLamViec = Int32.Parse(Console.ReadLine());
        }
    }
}
